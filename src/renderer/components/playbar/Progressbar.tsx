...
export const Progressbar = memo(() => {
  ...
  return (
    <div className="mb-1 flex h-fit w-full flex-row items-center justify-between gap-2 px-1.5 text-[9px] font-bold">
      ...
      <Slider min={0} step={1} max={state.duration || 1} value={state.duration ? progress : 0} thumb={{ height: "0.6rem", width: "0.2rem" }} onChange={(e) => methods.seekTo(Number(e.target.value))} />
