...
export function Card({ thumb, label1, label2, onClick }: { thumb: string; label1: string; label2: string; onClick: () => void }) {
  return (
    <div
      onClick={onClick}
    ...
    >
      <img src={thumb} loading="lazy" decoding="async" draggable={false} className="absolute inset-0 -z-10 h-full w-full object-cover" />
