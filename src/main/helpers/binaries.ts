...
import { DLP, FFMPEG, FFPROBE, WIN32, YT_DLP_BIN_URL as URL } from "../../shared/constants";
...
export const downloadFFMPEG = () =>
  promisify(ffbinaries.downloadBinaries.bind(ffbinaries, ["ffmpeg"], { destination: "./bin" }))().then(() => patch(FFMPEG));

export const downloadFFPROBE = () =>
  promisify(ffbinaries.downloadBinaries.bind(ffbinaries, ["ffprobe"], { destination: "./bin" }))().then(() => patch(FFPROBE));
